...
function CourseDetails() {
  ...
  console.log("response data course",response.data?.courseDetails[0])
  console.log("course content",courseContent)

  const handleBuyCourse = () => {
    if (token) {
      console.log("course id course details",courseId)
        ...
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            >
              ...
              <div>
                <p className="">
                  Created By {instructor?`${instructor.firstName} ${instructor.lastName}`:"Instructor"}
                </p>
              </div>
          ...
          <div className="max-w-[830px] ">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-wrap justify-between gap-2">
                <div className="flex gap-2">
                  ...
                  <span>{response?.data?.totalDuration} total duration</span>
                </div>
                <div>
                  <button
            ...
            <div className="mb-12 py-4">
              ...
              <div className="flex items-center gap-4 py-4">
                ...
                />
                <p className="text-lg">{instructor?`${instructor.firstName} ${instructor.lastName}`:"Instructor"}</p>
              </div>
